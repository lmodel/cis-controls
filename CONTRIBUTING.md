# Contributing to cis-controls

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
cis-controls. These guidelines are not strict rules.
...
The cis-controls team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the cis-controls technical leads
...
[issues]: https://github.com/lmodel/cis-controls/issues/
[pulls]: https://github.com/lmodel/cis-controls/pulls/
