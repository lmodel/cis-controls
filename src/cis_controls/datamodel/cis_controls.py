...
# Generation date: 2026-04-15T22:51:46
# Schema: cis-controls
#
# id: https://w3id.org/lmodel/cis-controls
# description: LinkML schema for the CIS Critical Security Controls (CIS Controls) Version 8.1.2
#   (March 2025). Models the 18 Controls and their Safeguards, including asset types,
#   security functions, and Implementation Groups as defined by the Center for Internet
...
class CISControl(YAMLRoot):
    """
    One of the 18 CIS Critical Security Controls — a high-level defensive action category that enterprises should
